...
/**
 * Mirrors the teacher dashboard's Profile tab structurally: a live/edit
 * toggle over the same public-page preview (ClassProfileView, embedded via
 * liveView), with Publish status and Verified tier folded in as part of the
 * profile — not Settings, same split teacher/profile-tab.tsx uses. Account-
 * wide stuff (notifications, refer & earn) lives in the separate Settings
 * tab instead, split out from what used to be one combined tab.
 */
export function ProfileTab({
  ...
  const t = useTranslations("instituteDashboard.profile");
