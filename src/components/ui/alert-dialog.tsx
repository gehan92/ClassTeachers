...
function AlertDialogFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("mt-4 flex flex-wrap items-center justify-end gap-2.5", className)}
      {...props}
    />
  )
}
