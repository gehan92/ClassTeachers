...
export function messageFor(t: Translator, n: NotificationRow): string {
  ...
  switch (n.type) {
    ...
    case "platform_fee_join_completed":
      return t("types.platform_fee_join_completed", { studentName: str(data.studentName) });
    case "exam_graded":
      return t("types.exam_graded", { examTitle: str(data.examTitle), grade: str(data.grade) });
    case "exam_submitted":
      return t("types.exam_submitted", { studentName: str(data.studentName), examTitle: str(data.examTitle) });
    case "assignment_submitted":
      return t("types.assignment_submitted", {
        studentName: str(data.studentName),
        assignmentTitle: str(data.assignmentTitle),
      });
    case "new_note":
    ...
    case "vacancy_application":
      return t("types.vacancy_application", { teacherName: str(data.teacherName), vacancyTitle: str(data.vacancyTitle) });
    case "vacancy_application_accepted":
      return t("types.vacancy_application_accepted", { instituteName: str(data.instituteName) });
    case "vacancy_application_declined":
      return t("types.vacancy_application_declined", { instituteName: str(data.instituteName) });
